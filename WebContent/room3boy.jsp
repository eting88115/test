...
<div class="w3">
  ...
  <div class="post" style=" margin-left: 480px;margin-top:25px">
      <h1 class="w3-text-teal"><b>男宿舍-房位結果</b></h1>
  </div>
...
<%
	...
	String sql = "SELECT floorID, roomID, roommember1, roommember2, roommember3, roommember4 FROM room where floorsex=1";
